<h2><a href="https://leetcode.com/problems/complex-number-multiplication/">537. Complex Number Multiplication</a></h2><p><a href="./complex_number_multiplication.cpp">Solution</a></p><p>A <a href="https://en.wikipedia.org/wiki/Complex_number" target="_blank">complex number</a> can be represented as a string on the form <code>"<strong>real</strong>+<strong>imaginary</strong>i"</code> where:</p>
